...
const DoctorList = () => {
    ...
    return (
        <>
            <div className='m-5 mt-0 max-h-[90vh] overflow-y-auto'>
                <h1 className='text-2xl mt-5 font-medium'>All Doctors</h1>
                <div className='w-full flex flex-wrap gap-4 pt-5 gap-y-6 justify-center sm:justify-start'>
