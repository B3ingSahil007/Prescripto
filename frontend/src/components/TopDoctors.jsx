    ...
    return (
        <>
            <div data-aos="zoom-in" className='flex flex-col items-center gap-4 my-16 text-gray-800 md:mx-10'>
                ...
                <div className='grid grid-cols-5 gap-4 pt-5 gap-y-6 px-3 sm:px-0 w-full'>
                ...
                <button onClick={() => { navigate('/doctors'), scrollTo(0, 0) }} className='bg-primary text-white py-2 px-16 mt-10 rounded-full hover:scale-105 transition-all duration-300'>More</button>
            </div>
        </>
    )
}
